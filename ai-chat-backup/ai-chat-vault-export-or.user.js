// ==UserScript==
// @name        AI Chat Vault — Export & Organize ChatGPT, Claude, Gemini
// @version     0.1.0
// @description Export, search and organize your AI conversations. 100% local — your chats never leave your device.
// @namespace   ai-chat-vault-export-organize-chatgpt-claude-gemini
...
// @grant       GM_openInTab
// @icon        data:image/png;base64,
...
(function() {
    // #region Logging
	  ...
	  const SCRIPT_NAME = "AI Chat Vault — Export & Organize ChatGPT, Claude, Gemini";
	  const _log = (...args) => {};
...
// #region Abstraction Layer Userscript Target
			...
			const EXTENSION_ASSETS_MAP = {
			  "src/popup/popup.html": "<!DOCTYPE html>\n<html>\n<head>\n  <meta charset=\"utf-8\" />\n  <style>\n    body { width: 260px; margin: 0; font-family: system-ui, sans-serif; background: #111; color: #eee; }\n    header { padding: 12px 14px 8px; font-weight: 600; font-size: 14px; }\n    header small { display: block; color: #8a8; font-weight: 400; margin-top: 2px; }\n    .actions { padding: 6px 14px 14px; display: flex; flex-direction: column; gap: 8px; }\n    button { padding: 9px 12px; border: 0; border-radius: 8px; cursor: pointer; font-size: 13px;\n             background: #2a2a2a; color: #eee; text-align: left; }\n    button:hover { background: #3a3a3a; }\n    button.primary { background: #4f46e5; }\n    button.primary:hover { background: #6058ee; }\n    #status { padding: 0 14px 12px; font-size: 12px; color: #999; min-height: 16px; }\n  </style>\n</head>\n<body>\n  <header>\n    AI Chat Vault\n    <small>100% local — chats never leave your device</small>\n  </header>\n  <div class=\"actions\">\n    <button id=\"save\" class=\"primary\">💾 Save this conversation</button>\n    <button id=\"export-md\">⬇️ Export as Markdown</button>\n    <button id=\"export-json\">⬇️ Export as JSON</button>\n    <button id=\"library\">📚 Open Library</button>\n  </div>\n  <div id=\"status\"></div>\n  <script src=\"data:text/javascript;base64,\"></script>\n</body>\n</html>\n"
			};
		...
		function buildPolyfill({ isBackground = false, isOtherPage = false } = {}) {
		  ...
		  const BUS = (function () {
		    ...
		    globalThis.__BUS = createEventBus(
		      "ai-chat-vault-export-organize-chatgpt-claude-gemini",
...
// #endregion
   ...
   // #region Background Script Environment
	...
	const START_BACKGROUND_SCRIPT = (function(){
	  ...
	  const scriptName = "AI Chat Vault — Export & Organize ChatGPT, Claude, Gemini";
	  const debug = "[AI Chat Vault — Export & Organize ChatGPT, Claude, Gemini]";
	  _log(debug + ' Executing background scripts...');
	
	  function executeBackgroundScripts(){
	    with(backgroundPolyfill){
	      // BG: src/background.js
	// AI Chat Vault — service worker.
	// Owns storage (chrome.storage.local) and markdown/JSON serialization.
	// No network calls except optional license activation (see lib/license.js).
	
	import { verifyLicense } from "./lib/license.js";
	
	const STORE_KEY = "vault_conversations";
	...
	async function saveConversation(conv) {
	  ...
	  // Same URL captured again replaces the older snapshot.
	  const idx = all.findIndex((c) => c.url === conv.url);
	  const entry = { id: idx >= 0 ? all[idx].id : crypto.randomUUID(), tags: [], ...conv };
	...
	function sanitizeFilename(name) {
	  return name.replace(/[\\/:*?"<>|]/g, "-").slice(0, 120) || "conversation";
	}
	  ...
	  (async () => {
	    switch (msg.type) {
	      case "SAVE_CONVERSATION": {
	        const id = await saveConversation(msg.conversation);
	        sendResponse({ ok: true, id });
	        break;
	      }
	      case "EXPORT_MARKDOWN": {
	        await download(
	          toMarkdown(msg.conversation),
	          `${sanitizeFilename(msg.conversation.title)}.md`,
	          "text/markdown"
	        );
	      ...
	      case "EXPORT_JSON": {
	        await download(
	          JSON.stringify(msg.conversation, null, 2),
	          `${sanitizeFilename(msg.conversation.title)}.json`,
	          "application/json"
	        );
	        sendResponse({ ok: true });
	        break;
	      ...
	      case "GET_ALL": {
	        sendResponse({ conversations: await getAll() });
	        break;
	      }
	      case "DELETE_CONVERSATION": {
	        const all = await getAll();
	        await chrome.storage.local.set({
	          [STORE_KEY]: all.filter((c) => c.id !== msg.id),
	        });
	        sendResponse({ ok: true });
	        break;
	      }
	      case "EXPORT_ALL_MARKDOWN": {
	        // Pro feature: bulk export as a single bundle.
	        ...
	        const all = await getAll();
	        const bundle = all.map(toMarkdown).join("\n\n\n====================\n\n\n");
	        await download(bundle, "ai-chat-vault-export.md", "text/markdown");
	        sendResponse({ ok: true, count: all.length });
	        break;
	      }
	      case "ACTIVATE_LICENSE": {
	        sendResponse(await verifyLicense(msg.key));
	        break;
	      }
	      default:
   ...
   // #endregion
	...
	const INJECTED_MANIFEST = {"manifest_version":3,"name":"AI Chat Vault — Export & Organize ChatGPT, Claude, Gemini","version":"0.1.0","description":"Export, search and organize your AI conversations. 100% local — your chats never leave your device.","permissions":["storage","unlimitedStorage","downloads","activeTab"],"optional_permissions":[],"content_scripts":[{"matches":["https://chatgpt.com/*","https://chat.openai.com/*","https://claude.ai/*","https://gemini.google.com/*"],"js":["src/content.js"],"run_at":"document_idle","css":[]}],"options_ui":{},"browser_action":{},"page_action":{},"action":{"default_popup":"src/popup/popup.html","default_title":"AI Chat Vault"},"icons":{"16":"icons/icon16.png","48":"icons/icon48.png","128":"icons/icon128.png"},"web_accessible_resources":[],"background":{"service_worker":"src/background.js","type":"module"},"_id":"ai-chat-vault-export-organize-chatgpt-claude-gemini"};
	...
	const EXTENSION_ICON = "data:image/png;base64,";
  ...
  // #region Document Idle
			...
			// AI Chat Vault — content script.
			// Scrapes the visible conversation on ChatGPT / Claude / Gemini into a
			// normalized {title, site, url, messages:[{role, text}]} object.
			// All extraction is DOM-only and stays local.
			
			(() => {
			  const SITE = location.hostname.includes("claude.ai")
			    ? "claude"
			    : location.hostname.includes("gemini.google.com")
			      ? "gemini"
			      : "chatgpt";
			
			  // Selector sets are ordered fallbacks — UIs change often, so each adapter
			  // tries selectors until one yields messages. Verified against July 2026 DOMs;
			  ...
			  const ADAPTERS = {
			    chatgpt: {
			      ...
			      title: () => document.title.replace(/ \| ChatGPT.*$/i, "").trim(),
			    },
			    claude: {
			      messages() {
			        // User turns and assistant turns render in distinct testid containers.
			        const turns = document.querySelectorAll(
			          '[data-testid="user-message"], [data-testid="assistant-message"], .font-user-message, .font-claude-message'
			        );
			        return Array.from(turns).map((n) => ({
			          role:
			            n.matches('[data-testid="user-message"], .font-user-message') ? "user" : "assistant",
			          text: extractText(n),
			        }));
			      },
			      title: () => document.title.replace(/ - Claude.*$/i, "").trim(),
			    },
			    gemini: {
			      messages() {
			      ...
			      title: () => document.title.replace(/ - Gemini.*$/i, "").trim(),
			    },
			  };
			
			  // Convert a message node to markdown-ish plain text, preserving code blocks.
			  function extractText(node) {
			    const clone = node.cloneNode(true);
			    // Fence code blocks so exports keep formatting.
			    ...
			    clone.querySelectorAll("button, svg, img[alt='']").forEach((el) => el.remove());
			    return clone.textContent.replace(/\n{3,}/g, "\n\n").trim();
			  }
			
			  function capture() {
			    const adapter = ADAPTERS[SITE];
			    const messages = adapter.messages().filter((m) => m.text);
			    if (!messages.length) return null;
			    return {
			      site: SITE,
			      url: location.href,
			      title: adapter.title() || "Untitled conversation",
			  ...
			  chrome.runtime.onMessage.addListener((msg, _sender, sendResponse) => {
			    if (msg.type === "CAPTURE_CONVERSATION") {
			      sendResponse({ conversation: capture() });
			    }
			    return false;
			  });
			})();
